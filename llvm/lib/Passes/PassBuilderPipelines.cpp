...
PassBuilder::buildModuleOptimizationPipeline(OptimizationLevel Level,
  ...
  if (Level == OptimizationLevel::O3) {
    printf("---------------------added-----------------\n");
    OptimizePM.addPass(custom_opts::BracketsMulTransform());
    OptimizePM.addPass(custom_opts::TripleBracketsMulTransform());
    OptimizePM.addPass(custom_opts::OneIsZeroTransform());
