; ModuleID = 'new_opts/opt1/check_opt.ll'
...
165:                                              ; preds = %165, %15
  %166 = phi i64 [ %182, %165 ], [ 0, %15 ]
  %167 = phi i64 [ %181, %165 ], [ 0, %15 ]
  ...
  %add1 = add nsw i32 %170, %172
  %add2 = add nsw i32 %170, %174
  %mul = mul nsw i32 %add1, %add2
  %179 = srem i32 %mul, 2
  ...
  br i1 %183, label %161, label %165, !llvm.loop !13

184:                                              ; preds = %161
  %185 = load ptr, ptr %164, align 8, !tbaa !14
...
194:                                              ; preds = %184
  ...
  %196 = load i8, ptr %195, align 8, !tbaa !25
  %197 = icmp eq i8 %196, 0
  br i1 %197, label %201, label %198

198:                                              ; preds = %194
  %199 = getelementptr inbounds i8, ptr %190, i64 67
...
207:                                              ; preds = %202, %198
  ...
  %209 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %164, i8 noundef signext %208)
...
212:                                              ; preds = %210
  %213 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 33)
          to label %214 unwind label %233

214:                                              ; preds = %212
  %215 = sub nsw i64 %163, %16
  %216 = sitofp i64 %215 to double
  %217 = fdiv double %216, 1.000000e+09
  %218 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo9_M_insertIdEERSoT_(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, double noundef %217)
          to label %219 unwind label %233

219:                                              ; preds = %214
  %220 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %218, ptr noundef nonnull @.str.1, i64 noundef 14)
          to label %221 unwind label %233

221:                                              ; preds = %219
  %222 = icmp eq ptr %145, null
...
231:                                              ; preds = %210, %207, %202, %201, %192, %161
  %232 = landingpad { ptr, i32 }
          cleanup
  br label %235

233:                                              ; preds = %219, %214, %212
  %234 = landingpad { ptr, i32 }
          cleanup
  br label %235

235:                                              ; preds = %233, %231, %159, %157, %155, %153, %151, %149
  %236 = phi ptr [ %145, %233 ], [ %145, %231 ], [ %30, %149 ], [ %30, %151 ], [ %30, %153 ], [ %30, %155 ], [ %30, %157 ], [ %30, %159 ]
  %237 = phi ptr [ %107, %233 ], [ %107, %231 ], [ %27, %149 ], [ %27, %151 ], [ %27, %153 ], [ %27, %155 ], [ %107, %157 ], [ %107, %159 ]
  %238 = phi ptr [ %69, %233 ], [ %69, %231 ], [ %24, %149 ], [ %24, %151 ], [ %69, %153 ], [ %69, %155 ], [ %69, %157 ], [ %69, %159 ]
  %239 = phi { ptr, i32 } [ %234, %233 ], [ %232, %231 ], [ %150, %149 ], [ %152, %151 ], [ %154, %153 ], [ %156, %155 ], [ %158, %157 ], [ %160, %159 ]
  %240 = icmp eq ptr %236, null
  br i1 %240, label %242, label %241

241:                                              ; preds = %235
  tail call void @_ZdlPv(ptr noundef nonnull %236) #12
  br label %242

242:                                              ; preds = %241, %235, %18
  %243 = phi { ptr, i32 } [ %21, %18 ], [ %239, %235 ], [ %239, %241 ]
  %244 = phi ptr [ %20, %18 ], [ %238, %235 ], [ %238, %241 ]
  %245 = phi ptr [ %19, %18 ], [ %237, %235 ], [ %237, %241 ]
